...
v27 = Venue.create({name: "Teatro Antico di Taormina", location: "Taormina, Italy", image: ""})
...
v32 = Venue.create({name: "Slane Castle", location: "County Meath, Ireland", image: ""})
v33 = Venue.create({name: "Jay Pritzker Pavilion ", location: "Chicago, IL, USA", image: ""})
v34 = Venue.create({name: "Tower Theater,", location: "Philadelphia, PA, USA", image: ""})
v35 = Venue.create({name: "El Club", location: "Detroit, MI, USA", image: ""})
v36 = Venue.create({name: "9:30 Club", location: "Washington DC, USA", image: ""})
v37 = Venue.create({name: "Brooklyn Steel", location: "Brooklyn, NY, USA", image: ""})
v38 = Venue.create({name: "Brooklyn Mirage", location: "Brooklyn, NY, USA", image: ""})
v39 = Venue.create({name: "Ottobar", location: "Baltimore, MD, USA", image: ""})
v40 = Venue.create({name: "The 100 Club", location: "London, UK", image: ""})
v41 = Venue.create({name: "Sidecar", location: "Barcelona, Spain", image: ""})
v42 = Venue.create({name: "The Drake Hotel", location: "Toronto, Canada", image: ""})
v43 = Venue.create({name: "Zapata Café Bar", location: "Berlin, Germany", image: ""})
v44 = Venue.create({name: "Prinzenbar", location: "Berlin, Germany", image: ""})
v45 = Venue.create({name: "Vicar Street", location: "Dublin, Ireland", image: ""})
v46 = Venue.create({name: "Cherry Bar ", location: "Melbourne, Australia", image: ""})
v47 = Venue.create({name: "The Fonda", location: "Los Angeles, CA, USA", image: ""})
v48 = Venue.create({name: "Jones Beach Theater", location: "Wantagh, NY, USA", image: ""})
v49 = Venue.create({name: "Preservation Hall", location: "New Orleans, LA, USA", image: ""})
v50 = Venue.create({name: "Casbah", location: "San Diego, CA, USA", image: ""})
v51 = Venue.create({name: "King Tuts Wah Wah Hut", location: "Glasgow, Scotland, UK", image: ""})
v52 = Venue.create({name: "Palacio de Bellas Artes", location: "Mexico City, Mexico", image: ""})
v53 = Venue.create({name: "House of Blues", location: "Boston, MA, USA", image: ""})
