...
a19 = Artist.create({ name: 'Morgan Wallen', image: "/artist-images/morgan_wallen.jpg" , genre_id: g3.id})
...
a40 = Artist.create({ name: 'Fall Out Boy', image: "/artist-images/fall-out-boy.jpg", genre_id: g4.id})
...
a47 = Artist.create({ name: 'H.E.R.', image: "/artist-images/her.jpg", genre_id: g7.id})
...
v9 = Venue.create({name: "The Greek Theatre", location: "Los Angeles, CA, USA", image: "/venues-images/the-greek.jpg"})
v9 = Venue.create({name: "Merriweather Post Pavilion", location: "Columbia, MD, USA", image: "/venues-images/merriweathers.jpg"})
...
v23 = Venue.create({name: "Arena of Nîmes", location: "Nîmes, France", image: "/venues-images/arena-of-nimes.jpg"})
...
v37 = Venue.create({name: "Brooklyn Steel", location: "Brooklyn, NY, USA", image: "/venues-images/brooklyn-steel.jpg"})
v38 = Venue.create({name: "Brooklyn Mirage", location: "Brooklyn, NY, USA", image: "/venues-images/brooklyn-mirage.jpg"})
...
v46 = Venue.create({name: "Cherry Bar ", location: "Melbourne, Australia", image: "/venues-images/cherry-bar.jpg"})
...
v52 = Venue.create({name: "Palacio de Bellas Artes", location: "Mexico City, Mexico", image: "/venues-images/palacio-mexico-city.jpg"})
