...
a47 = Artist.create({ name: '', genre_id: })
a48 = Artist.create({ name: '', genre_id: })
a49 = Artist.create({ name: 'Jack White', genre_id: })
a50 = Artist.create({ name: '', genre_id: })
a51 = Artist.create({ name: '', genre_id: })
a52 = Artist.create({ name: 'Kaytranada', genre_id: })
a53 = Artist.create({ name: '', genre_id: })
a54 = Artist.create({ name: '', genre_id: })
a55 = Artist.create({ name: '', genre_id: })
a56 = Artist.create({ name: 'Kygo', genre_id: })
a57 = Artist.create({ name: '', genre_id: })
a58 = Artist.create({ name: 'Ozuna', genre_id: })
a59 = Artist.create({ name: '', genre_id: })
a60 = Artist.create({ name: 'Alesso', genre_id: })
a61 = Artist.create({ name: '', genre_id: })
a62 = Artist.create({ name: '', genre_id: })
a63 = Artist.create({ name: 'Afrojack', genre_id: })
a64 = Artist.create({ name: '', genre_id: })
a65 = Artist.create({ name: '', genre_id: })
a66 = Artist.create({ name: 'Amelie Lens', genre_id: })
a67 = Artist.create({ name: '', genre_id: })
a68 = Artist.create({ name: '', genre_id: })
