...
a57 = Artist.create({ name: 'JAY-Z', image: "", genre_id: g2.id})
a58 = Artist.create({ name: 'Ozuna', image: "", genre_id: g8.id})
a59 = Artist.create({ name: 'Metallica', image: "", genre_id: g4.id})
a60 = Artist.create({ name: 'Alesso', image: "", genre_id: g6.id})
a61 = Artist.create({ name: 'Kehlani', image: "", genre_id: g7.id})
a62 = Artist.create({ name: 'Kanye West', image: "", genre_id: g2.id})
a63 = Artist.create({ name: 'Afrojack', image: "", genre_id: g6.id})
a64 = Artist.create({ name: 'Vijay Iyer', image: "", genre_id: g5.id})
a65 = Artist.create({ name: 'Ari Lennox', image: "", genre_id: g7.id})
a66 = Artist.create({ name: 'Amelie Lens', image: "", genre_id: g6.id})
a67 = Artist.create({ name: 'Ambrose Akinmusire', image: "", genre_id: g5.id})
a68 = Artist.create({ name: 'Michael Bublé', image: "", genre_id: g5.id})
a69 = Artist.create({ name: 'Ava Max', image: "", genre_id: g1.id})
a70 = Artist.create({ name: 'Beyonce', image: "", genre_id: g1.id})
a71 = Artist.create({ name: 'Peggy Gou', image: "", genre_id: g6.id})
a72 = Artist.create({ name: 'Lady Gaga', image: "", genre_id: g1.id})
a73 = Artist.create({ name: 'Summer Walker', image: "", genre_id: g7.id})
a74 = Artist.create({ name: 'Lizzo', image: "", genre_id: g1.id})
a75 = Artist.create({ name: 'Lil Tjay', image: "", genre_id: g2.id})
a76 = Artist.create({ name: 'Lil Baby', image: "", genre_id: g2.id})
a77 = Artist.create({ name: 'Esperanza Spalding', image: "", genre_id: g5.id})
a78 = Artist.create({ name: 'Burna Boy', image: "", genre_id: g9.id})
a79 = Artist.create({ name: 'Brad Mehdlau', image: "", genre_id: g5.id})
a80 = Artist.create({ name: 'Wizkid', image: "", genre_id: g9.id})
a81 = Artist.create({ name: 'Mr Eazi', image: "", genre_id: g9.id})
a82 = Artist.create({ name: 'Sarkodie', image: "", genre_id: g9.id})
a83 = Artist.create({ name: 'Yemi Alade', image: "", genre_id: g9.id})
a84 = Artist.create({ name: 'Kizz Daniel', image: "", genre_id: g9.id})
